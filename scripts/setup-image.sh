...
TABLE_NAME="table-name" # no hypens
...
mysql -u root --password=$SQL_PASSWORD -h $SQL_IP_ADDRESS -e "CREATE DATABASE $DATABASE_NAME;"

echo CREATING TABLE IN DATABASE...
mysql -u root --password=$SQL_PASSWORD -h $SQL_IP_ADDRESS -e "CREATE TABLE $DATABASE_NAME.$TABLE_NAME ($COLUMN_PROPERTIES);"
